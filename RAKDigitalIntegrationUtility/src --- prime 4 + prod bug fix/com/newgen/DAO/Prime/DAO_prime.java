...
public final class DAO_prime
{
	private static String loggerName = "DAO_prime_Logger";
    protected static org.apache.log4j.Logger DAOPrimeLogger = org.apache.log4j.Logger.getLogger(loggerName);;
    ...
    protected static void setLogger()
    {
    	try
		{
			...
			p.load(new FileInputStream(System.getProperty("user.dir")+ File.separator + "log4jFiles"+ File.separator+ "DAO_Prime_Logger.properties"));
			String dynamicLog = null;
			String orgFileName = null;
			File d = null;
			File fl = null;

			dynamicLog = "Logs/DAO_prime_Logger/"+logDateFormat.format(date)+"/DAO_prime_Log.xml";
