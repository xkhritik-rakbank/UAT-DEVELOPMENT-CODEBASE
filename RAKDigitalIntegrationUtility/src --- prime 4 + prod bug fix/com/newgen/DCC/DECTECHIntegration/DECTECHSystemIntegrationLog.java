...
public final class DECTECHSystemIntegrationLog
{
	private static String loggerName = "DECTECHSystemIntegrationLogger";
    protected static org.apache.log4j.Logger DECTECHSystemIntegrationLogger = org.apache.log4j.Logger.getLogger(loggerName);;
    ...
    protected static void setLogger()
    {
    	try
		{
			...
			p.load(new FileInputStream(System.getProperty("user.dir")+ File.separator + "log4jFiles"+ File.separator+ "DECTECHSystemIntegrationLog4j.properties"));
			String dynamicLog = null;
			String orgFileName = null;
			File d = null;
			File fl = null;

			dynamicLog = "Logs/DCC_DECTECH_SystemIntegration_Log/"+logDateFormat.format(date)+"/DCC_DECTECH_SystemIntegration_Log.xml";
