...
public class Digital_PL_CommomMethod extends CommonMethods{
	...
	//Calculate DOJ formate should be YYYY-MM-DD
		...
		public String socketConnection(String cabinetName, String username, String sessionId, String sJtsIp, String iJtsPort, String processInstanceID, String ws_name,
