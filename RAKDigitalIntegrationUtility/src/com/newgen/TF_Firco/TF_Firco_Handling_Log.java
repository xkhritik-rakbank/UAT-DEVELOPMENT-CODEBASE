...
public final class TF_Firco_Handling_Log
{
	private static String loggerName = "TF_Firco_Handling_Log";
    protected static org.apache.log4j.Logger TF_Firco_HandlingLogger = org.apache.log4j.Logger.getLogger(loggerName);;
    ...
    protected static void setLogger()
    {
    	try
		{
			...
			p.load(new FileInputStream(System.getProperty("user.dir")+ File.separator + "log4jFiles"+ File.separator+ "TF_Firco_Log4j.properties"));
			String dynamicLog = null;
			String orgFileName = null;
			File d = null;
			File fl = null;

			dynamicLog = "Logs/TF_Firco_Handling_Log/"+logDateFormat.format(date)+"/TF_Firco_Log.xml";
