...
public final class DAO_WI_Update
{
	private static String loggerName = "DAOWIUPDATELogger";
    protected static org.apache.log4j.Logger DAOWIUPDATELogger = org.apache.log4j.Logger.getLogger(loggerName);;
    ...
    protected static void setLogger()
    {
    	try
		{
			...
			p.load(new FileInputStream(System.getProperty("user.dir")+ File.separator + "log4jFiles"+ File.separator+ "DAOWIUPDATELogger.properties"));
			String dynamicLog = null;
			String orgFileName = null;
			File d = null;
			File fl = null;

			dynamicLog = "Logs/DAOWIUPDATELogger/"+logDateFormat.format(date)+"/DAO_WIUPDATE_Log.xml";
