...
public class CommonConnection
{
	...
	private static String sProcessNameDPL = "";
	...
	public static String getsProcessNameDPL() {
		return sProcessNameDPL;
	}
	public static void setsProcessNameDPL(String sProcessNameDPL) {
		CommonConnection.sProcessNameDPL = sProcessNameDPL;
	}
