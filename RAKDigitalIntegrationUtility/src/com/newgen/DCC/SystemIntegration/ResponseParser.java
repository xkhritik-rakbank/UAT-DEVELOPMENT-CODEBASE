...
public class ResponseParser
  {
      ...
      String prod, String subprod, String cifId, String cust_type)
    {
    	...
    	try
    	{
    		...
    		String subTagName = "";
    		//String dpl_processname = "";
    		DCCSystemIntegrationLog.DCCSystemIntegrationLogger.debug("gets ProcessName:"+CommonConnection.getsProcessNameDPL());
    		
    		if("Digital_PL".equalsIgnoreCase(CommonConnection.getsProcessNameDPL()))
			{
    			sTableName = "ng_dpl_cust_extexpo_ChequeDetails";
			}else{
    		...
    		if (flag1.equalsIgnoreCase("true"))
    		{
    			...
    			if("Digital_PL".equalsIgnoreCase(CommonConnection.getsProcessNameDPL()))
    			{
    				sTableName = "ng_dpl_cust_extexpo_LoanDetails";
    			}else{
    			...
    			if (flag1.equalsIgnoreCase("true"))
    			{
    				...
    				if("Digital_PL".equalsIgnoreCase(CommonConnection.getsProcessNameDPL()))
        			{
        				sTableName = "ng_dpl_cust_extexpo_CardDetails";
        			}else{
    				...
    				if (flag1.equalsIgnoreCase("true"))
    				{
    					...
    					if("Digital_PL".equalsIgnoreCase(CommonConnection.getsProcessNameDPL()))
            			{
            				sTableName = "ng_dpl_cust_extexpo_Derived";
            			}else{
    					...
    					if (flag1.equalsIgnoreCase("true"))
    					{
    						...
    						if("Digital_PL".equalsIgnoreCase(CommonConnection.getsProcessNameDPL()))
                			{
                				sTableName = "ng_dpl_cust_extexpo_RecordDestribution";
                			}else{
    						...
    						if (flag1.equalsIgnoreCase("true"))
    						{
    							...
    							if("Digital_PL".equalsIgnoreCase(CommonConnection.getsProcessNameDPL()))
                    			{
                    				sTableName = "ng_dpl_cust_extexpo_AccountDetails";
                    			}else{
    							...
    							if (flag1.equalsIgnoreCase("true"))
    							{
    								...
    								if("Digital_PL".equalsIgnoreCase(CommonConnection.getsProcessNameDPL()))
                        			{
                        				sTableName = "ng_dpl_cust_extexpo_ServicesDetails";
                        			}else{
    								...
    								if(flag1.equalsIgnoreCase("true")){
    									...
    									if("Digital_PL".equalsIgnoreCase(CommonConnection.getsProcessNameDPL()))
                            			{
                            				sTableName = "ng_dpl_cust_extexpo_CaseDetails";
                            			}else{
    									...
    									if (flag1.equalsIgnoreCase("true"))
    									{
    										...
    										if("Digital_PL".equalsIgnoreCase(CommonConnection.getsProcessNameDPL()))
                                			{
                                				sTableName = "ng_dpl_cust_extexpo_ExpToSalRatio";
                                			}else{
    										...
    										if (flag1.equalsIgnoreCase("true"))
    										{
    											...
    											if("Digital_PL".equalsIgnoreCase(CommonConnection.getsProcessNameDPL()))
                                    			{
                                    				sTableName = "ng_dpl_cust_extexpo_SalCreditDtls";
                                    			}else{
                ...
                for (Map.Entry<String, String> entry : map.entrySet())
                  {
                    ...
                    if (sTableName.equalsIgnoreCase("USR_0_iRBL_InternalExpo_CardDetails"))
                    ...
                    else if (sTableName.equalsIgnoreCase("ng_dcc_cust_extexpo_ChequeDetails"))
                      {
                        ...
                        sWhere = "Wi_Name='" + wi_name + "' AND Number = '" + entry.getKey() + "'";
					  ...
					  else if (sTableName.equalsIgnoreCase("ng_dpl_cust_extexpo_ChequeDetails"))
                   	 	{
                      		columnName = valueArr[0] + ",CifId,Request_Type,Wi_Name";
                      		columnValues = valueArr[1] + ",'" + cifId + "','" + returnType + "','" + wi_name + "'";
                      		sWhere = "Wi_Name='" + wi_name + "' AND Number = '" + entry.getKey() + "'";
                   		...
                   		// Rubi - DPL Tables
                    else if (sTableName.equalsIgnoreCase("ng_dcc_cust_extexpo_LoanDetails")|| sTableName.equalsIgnoreCase("ng_dpl_cust_extexpo_LoanDetails"))
                      {
                    ...
                    //Kamran 23012023
                   // Rubi - DPL Tables
                    else if (sTableName.equalsIgnoreCase("ng_dcc_cust_extexpo_ExpToSalRatio") || sTableName.equalsIgnoreCase("ng_dpl_cust_extexpo_ExpToSalRatio"))
                    {
                    ...
                    else if (sTableName.equalsIgnoreCase("ng_dpl_cust_extexpo_SalCreditDtls")) // Rubi - DPL Tables
                    {
                    	DCCSystemIntegrationLog.DCCSystemIntegrationLogger.debug("inside ng_dpl_cust_extexpo_SalCreditDtls table condition " );
                    	String SalCreditHistory = parseSalaryCreditHistory(parseXml,entry.getKey(), "SalaryCreditDetails", "<SalaryCreditHistory>", "</SalaryCreditHistory>");
                        SalCreditHistory = SalCreditHistory.replace("\n", "").replace("\r", "");
                        Map<String, String> tagValuesMap_salhistory = getTagDataParent_deep_new("<SalaryCreditDetails>"+SalCreditHistory+"</SalaryCreditDetails>", "SalaryCreditHistory", subTagName, subtag_single);
                        String DPAccountNo="";
                        DPAccountNo= get_tagValue(columnName,columnValues,"DPAccountNo");
                        String IBAN= get_tagValue(columnName,columnValues,"IBAN");
                        
                        Save_SalaryCreditHistory(tagValuesMap_salhistory, wi_name,entry.getKey(),DPAccountNo, "ng_dpl_cust_extexpo_SalCreditHis", wrapperIP, wrapperPort, sessionId, cabinetName,IBAN);
                        columnName = valueArr[0] + ",CifId,Wi_Name";
                        columnValues = valueArr[1]  + ",'"+ cifId + "','" + wi_name + "'";
                        String columnName_arr[] = columnName.split(",");
                        String columnValues_arr[] = columnValues.split(",");
                    ...
                    else if (sTableName.equalsIgnoreCase("ng_dcc_cust_extexpo_CardDetails")||sTableName.equalsIgnoreCase("ng_dpl_cust_extexpo_CardDetails"))
                      {
                    ...
                    else if (sTableName.equalsIgnoreCase("ng_dcc_cust_extexpo_Derived")||sTableName.equalsIgnoreCase("ng_dpl_cust_extexpo_Derived"))
                      {
                    ...
                    else if (sTableName.equalsIgnoreCase("ng_dcc_cust_extexpo_RecordDestribution")||sTableName.equalsIgnoreCase("ng_dpl_cust_extexpo_RecordDestribution"))
                      {
                    ...
                    //Changes Done to save data in NG_RLOS_CUSTEXPOSE_RecordDestribution table on 14th sept by Aman
                    //Deepak Child workitem added in both columnName & columnValues to get it saved in backend - 8 July 2019.
                    else if (sTableName.equalsIgnoreCase("ng_dcc_cust_extexpo_AccountDetails")||sTableName.equalsIgnoreCase("ng_dpl_cust_extexpo_AccountDetails"))
                      {
                        columnName = valueArr[0] + ",CifId,Request_Type,Wi_Name";
                        columnValues = valueArr[1] + ",'" + cifId + "','" + returnType + "','" + wi_name + "'";
                        String columnName_arr[] = columnName.split(",");
                    ...
                    else if (sTableName.equalsIgnoreCase("ng_dcc_cust_extexpo_ServicesDetails")||sTableName.equalsIgnoreCase("ng_dpl_cust_extexpo_ServicesDetails"))
                      {
                        columnName = valueArr[0] + ",CifId,Request_Type,Wi_Name";
                        columnValues = valueArr[1] + ",'" + cifId + "','" + returnType + "','" + wi_name  + "'";
                        String columnName_arr[] = columnName.split(",");
                  ...
                  //Deepak 22 july 2019 new condition added to save custinfo
  				  ...
  				  //Added by Pooja 
  					...
  					//ended here
					else if (sTableName.equalsIgnoreCase("ng_dpl_cust_extexpo_CaseDetails")) {

						columnName = valueArr[0] + ",Wi_Name,Request_Type,CifId";
						columnValues = valueArr[1] + ",'" + wi_name + "','" + returnType + "','" + cifId + "'";
						sWhere = "Wi_Name='" + wi_name + "' AND ProviderCaseNo = '" + entry.getKey() + "'";
					}
    ...
    public static Map<String, String> getTagDataParent_deep_new(String parseXml, String tagName, String sub_tag, String subtag_single) {
		...
		try {
			...
			for (int i = 0; i < nList_loan.getLength(); i++) {
				...
				//Added By rubi 
				else if ("CaseDetails".equalsIgnoreCase(tagName) && "Digital_PL".equalsIgnoreCase(CommonConnection.getsProcessNameDPL())) {
					id = ch_nodeList.item(2).getTextContent();
				}
				else {
					id = ch_nodeList.item(0).getTextContent();
				}
	...
	public static String Save_SalaryCreditHistory(Map<String, String> SalaryCreditHistory_map,String Wi_name,String account_Id,String DPAccountNo, String sTableName, String wrapperIP, String wrapperPort, String sessionId,
			String cabinetName,String IBAN) {
		String Output_desired = "";
		try {
			...
			for (Map.Entry<String, String> entry : map.entrySet())
			{
				...
				// columnValues=columnValues+",'"+getCellData(SheetName1, rCnt, cCnt)+"'";
				//colValue = "'"+valueArr[1].replaceAll("[,]", "','")+"'";
				//new column add in ng_dpl_cust_extexpo_SalCreditHis by rubi
				if("ng_dpl_cust_extexpo_SalCreditHis".equalsIgnoreCase(sTableName)){
					columnName = valueArr[0] + ", CBAccountNo, DPAccountNo, Wi_Name,IBAN";
					columnValues = valueArr[1] + ",'" + account_Id + "', '"+DPAccountNo+"', '" + Wi_name+"', '" + IBAN + "'";
