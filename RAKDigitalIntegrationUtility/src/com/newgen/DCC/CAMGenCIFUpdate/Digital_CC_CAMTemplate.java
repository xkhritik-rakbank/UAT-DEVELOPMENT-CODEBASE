...
public class Digital_CC_CAMTemplate {
	...
	public String generate_CAM_ReportT(String pdfName, String Cif_Id, String processInstanceID, String sessionId)
		...
		String Query = "select distinct Is_STP,case when MiddleName is null then CONCAT(FirstName,' ',LastName) else CONCAT(FirstName,' ',MiddleName,' ',LastName) end as CUSTOMERNAME ,Nationality_Desc, Cust_Decl_Salary,FinalTAI,"
				...
				+ "delegation_authority,Score_range,Dectech_Decision,Net_Salary1,Net_Salary2,Net_Salary3,Non_STP_reason,Underwriting_decision,UW_Decision,Decision, AECB_Sal_Month_1,AECB_Sal_Month_2,AECB_Sal_Month_3 from NG_DCC_EXTTABLE with (NOLOCK) where Wi_Name ='"
				+ processInstanceID + "'";
		...
		String AECB_Salary1 = xmlParserData.getValueOf("AECB_Sal_Month_1");
		DCC_CamGenrateteLog.debug("AECB_Salary1: " + AECB_Salary1);

		String AECB_Salary2 = xmlParserData.getValueOf("AECB_Sal_Month_2");
		DCC_CamGenrateteLog.debug("AECB_Salary2: " + AECB_Salary2);

		String AECB_Salary3 = xmlParserData.getValueOf("AECB_Sal_Month_3");
		DCC_CamGenrateteLog.debug("AECB_Salary3: " + AECB_Salary3);
		...
		attrbList += "&<AECB_Salary_1>&" + AECB_Salary1; 
		attrbList += "&<AECB_Salary_2>&" + AECB_Salary2;
		attrbList += "&<AECB_Salary_3>&" + AECB_Salary3;
