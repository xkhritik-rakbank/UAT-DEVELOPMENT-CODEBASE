...
public final class DAONotifyAPPLog
{
	private static String loggerName = "DAONotifyAppLogger";
    protected static org.apache.log4j.Logger DAONotifyAPPLogger = org.apache.log4j.Logger.getLogger(loggerName);;
    ...
    protected static void setLogger()
    {
    	try
		{
			...
			p.load(new FileInputStream(System.getProperty("user.dir")+ File.separator + "log4jFiles"+ File.separator+ "DAONotifyAppLogger.properties"));
			String dynamicLog = null;
			String orgFileName = null;
			File d = null;
			File fl = null;

			dynamicLog = "Logs/DAO_NotifyAp_Log/"+logDateFormat.format(date)+"/DAO_NotifyAp_Log.xml";
