...
public class DCC_Notify_CAPS {
			...
			HashMap<String, String> socketDetailsMap)
	{
		...
		try
		{
			...
			String DBQuery = "SELECT CIF,Prospect_id,NOTIFY_CAPS_STATUS,ECRN,CRN,RM_Code,Credit_Shield_Flag,FinalTAI,Net_salary1_date,FinalDBR,Final_Limit,cast(SUBSTRING(Net_salary1_date,9,11)as int)+2 as salary_day,delegation_authority as ApprovalLevelCode,"+
