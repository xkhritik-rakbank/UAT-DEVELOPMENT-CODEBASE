...
public final class DAO_ACC_CLO_log
{
	private static String loggerName = "DAO_ACC_CLO_logger";
    protected static org.apache.log4j.Logger DAO_ACC_CLO_logger = org.apache.log4j.Logger.getLogger(loggerName);;
    ...
    protected static void setLogger()
    {
    	try
		{
			...
			p.load(new FileInputStream(System.getProperty("user.dir")+ File.separator + "log4jFiles"+ File.separator+ "DAO_ACC_CLO.properties"));
			String dynamicLog = null;
			String orgFileName = null;
			File d = null;
			File fl = null;

			dynamicLog = "Logs/DAO_ACC_CLO_logger/"+logDateFormat.format(date)+"/DAO_ACC_CLO_logger.xml";
