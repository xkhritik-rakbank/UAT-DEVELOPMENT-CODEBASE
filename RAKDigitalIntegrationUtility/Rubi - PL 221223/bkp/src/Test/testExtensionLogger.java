...
public final class testExtensionLogger
{
	private static String loggerName = "DAOExtensionLogger";
    protected static org.apache.log4j.Logger DAOExtensionLogger = org.apache.log4j.Logger.getLogger(loggerName);;
    ...
    protected static void setLogger()
    {
    	try
		{
			...
			p.load(new FileInputStream(System.getProperty("user.dir")+ File.separator + "log4jFiles"+ File.separator+ "DAOExtensionLogger.properties"));
			String dynamicLog = null;
			String orgFileName = null;
			File d = null;
			File fl = null;

			dynamicLog = "Logs/DAOExtensionLog/"+logDateFormat.format(date)+"/DAOExtensionLogger.xml";
