...
public class DCC_Service_Maintenance_Log {

	private static String loggerName = "DCCServiceMaintenance";
    protected static org.apache.log4j.Logger DCCServiceMaintenance = org.apache.log4j.Logger.getLogger(loggerName);
    ...
    protected static void setLogger()
    {
    	try
		{
			...
			p.load(new FileInputStream(System.getProperty("user.dir")+ File.separator + "log4jFiles"+ File.separator+ "DCCServiceMaintenance_Log4j.properties"));
			String dynamicLog = null;
			String orgFileName = null;
			File d = null;
			File fl = null;

			dynamicLog = "Logs/DCC_Service_Maintenance_Log/"+logDateFormat.format(date)+"/DCC_Service_Maintenance_Log.xml";
