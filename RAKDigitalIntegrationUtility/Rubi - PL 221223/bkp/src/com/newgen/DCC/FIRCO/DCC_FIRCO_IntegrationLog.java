...
Module					: RAOP Status
File Name				: iRBLFircoHoldLog.java
...
public final class DCC_FIRCO_IntegrationLog
{
	private static String loggerName = "DCC_FIRCO_Integration_Log";
    protected static org.apache.log4j.Logger DCC_FIRCOIntegrationLogger = org.apache.log4j.Logger.getLogger(loggerName);;
    ...
    protected static void setLogger()
    {
    	try
		{
			...
			p.load(new FileInputStream(System.getProperty("user.dir")+ File.separator + "log4jFiles"+ File.separator+ "DCC_FIRCO_Integration_log4j.properties"));
			String dynamicLog = null;
			String orgFileName = null;
			File d = null;
			File fl = null;

			dynamicLog = "Logs/DCC_FIRCO_Integration_Log/"+logDateFormat.format(date)+"/DCC_FIRCO_Integration_Log.xml";
