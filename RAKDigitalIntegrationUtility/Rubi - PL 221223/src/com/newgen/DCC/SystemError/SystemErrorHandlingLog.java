...
public final class SystemErrorHandlingLog
{
	private static String loggerName = "DCC_System_Error_Handling_Log";
    protected static org.apache.log4j.Logger SystemErrorHandlingLogger = org.apache.log4j.Logger.getLogger(loggerName);;
    ...
    protected static void setLogger()
    {
    	try
		{
			...
			p.load(new FileInputStream(System.getProperty("user.dir")+ File.separator + "log4jFiles"+ File.separator+ "DCC_System_Error_Log4j.properties"));
			String dynamicLog = null;
			String orgFileName = null;
			File d = null;
			File fl = null;

			dynamicLog = "Logs/DCC_System_Error_Handling_Log/"+logDateFormat.format(date)+"/DCC_System_Error_Handling_Log.xml";
