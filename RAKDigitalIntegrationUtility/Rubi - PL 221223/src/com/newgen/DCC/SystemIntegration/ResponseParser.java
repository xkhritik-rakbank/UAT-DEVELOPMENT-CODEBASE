                ...
                for (Map.Entry<String, String> entry : map.entrySet())
                  {
                   ...
                   // Rubi - DPL Tables
                    ...
                    else if (sTableName.equalsIgnoreCase("ng_dpl_cust_extexpo_SalCreditDtls")) // Rubi - DPL Tables
                    {
                        ...
                        String DPAccountNo="";
                        DPAccountNo= get_tagValue(columnName,columnValues,"DPAccountNo");
                        Save_SalaryCreditHistory(tagValuesMap_salhistory, wi_name,entry.getKey(),DPAccountNo, "ng_dpl_cust_extexpo_SalCreditHis", wrapperIP, wrapperPort, sessionId, cabinetName);
                        columnName = valueArr[0] + ",CifId,Wi_Name";
                        columnValues = valueArr[1]  + ",'"+ cifId + "','" + wi_name + "'";
                        String columnName_arr[] = columnName.split(",");
                        String columnValues_arr[] = columnValues.split(",");
                  ...
                  //Deepak 22 july 2019 new condition added to save custinfo
  				  ...
  				  //above changes Done to save AccountType in ng_RLOS_CUSTEXPOSE_AcctDetails table on 29th Dec by Disha
  				  //Added by Pooja 
					else if (sTableName.equalsIgnoreCase("ng_dcc_cust_extexpo_CaseDetails")||sTableName.equalsIgnoreCase("ng_dpl_cust_extexpo_CaseDetails")) {
