            ...
            if("Y".equalsIgnoreCase(flag) && CheckGridDataMap.get("Dectech_Flag").equalsIgnoreCase("Y") && !"Y".equalsIgnoreCase(Is_CAM_Generated))
		        {
              	...
              	String DBQuery1 = "SELECT CIF,IsSTP,DectechDecision,IsFIRCOHit,EFMS_Status,FTS_Decision,IsAECBSalary FROM NG_DPL_EXTTABLE with(nolock) WHERE WINAME='" + processInstanceID + "'";
