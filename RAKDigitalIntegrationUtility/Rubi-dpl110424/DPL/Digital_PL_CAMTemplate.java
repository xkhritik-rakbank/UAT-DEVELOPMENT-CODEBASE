...
public class Digital_PL_CAMTemplate {
	...
	public String DPL_generate_CAM_ReportT(String pdfName, String Cif_Id, String processInstanceID, String sessionId)
		...
		String Query = "select distinct a.IsSTP,case when a.MiddleName is null then CONCAT(a.FirstName,' ',a.LastName) else "
				...
				+ "a.Nationality,a.Score_range,a.AECB_Score, a.EmployerName, a.StartofJob,a.Dec_Remarks,a.JobTitle,a.delegation_authority,"
...
//		logger.debug("Age: " + Age);
		...
		String QueryFTS ="select net_salary_month_1,net_salary_month_2,net_salary_month_3 from NG_DPL_IncomeExpense with (NOLOCK) where WI_Name ='" + processInstanceID + "'";
		...
		String ALOC_REMARKS_PL = xmlParserDataDecisionHistory.getValueOf("ALOC_REMARKS_PL");
		logger.debug("ALOC_REMARKS_PL: " + ALOC_REMARKS_PL);
		
		
		String ALOC_REMARKS_CC = xmlParserDataDecisionHistory.getValueOf("ALOC_REMARKS_CC");
		...
		if ("0".equalsIgnoreCase(MainCode) && TotalRecords > 0) {
			...
			String columnNames = "COMPANY_STATUS_CC,COMPANY_STATUS_PL,Employer_Category_PL_Expat";
			String columnValues = "'" + COMPANY_STATUS_CC + "','" + COMPANY_STATUS_PL + "','" + EMPLOYER_CATEGORY_PL + "'";
			...
			String columnNames="WI_NAME,Employment_Type,Date_Of_Joining,Designation,Company_Status_CC,Company_Status_PL,Employer_Category_PL_Expat,Employer_Category_PL_National,CC_ALOC_Remarks,PL_ALOC_Remarks,Industry,Sub_Industry";
			String columnValues="'"+processInstanceID+"','','"+StartofJob+"','"+JobTitle+"','"+COMPANY_STATUS_CC+"','"+COMPANY_STATUS_PL+"','"+EMPLOYER_CATEGORY_PL_EXPAT+"','"+EMPLOYER_CATEGORY_PL_NATIONAL+"','"+ALOC_REMARKS_CC+"','"+ALOC_REMARKS_PL+"','"+INDUSTRY_SECTOR+"',''";
