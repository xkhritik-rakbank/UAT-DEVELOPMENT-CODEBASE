...
public class DCC_UpdateAssignCIFLog {

	private static String loggerName = "DCC_Update_And_Assign_CIF_Logger";
    protected static org.apache.log4j.Logger DCC_Update_And_Assign_CIF_Logger = org.apache.log4j.Logger.getLogger(loggerName);;
    ...
    protected static void setLogger()
    {
    	try
		{
			...
			p.load(new FileInputStream(System.getProperty("user.dir")+ File.separator + "log4jFiles"+ File.separator+ "DCC_UpdateAndAssignCIF_log4j.properties"));
			String dynamicLog = null;
			String orgFileName = null;
			File d = null;
			File fl = null;

			dynamicLog = "Logs/DCC_Update_And_Assign_CIF_Logs/"+logDateFormat.format(date)+"/DCC_Update_And_Assign_CIF_Log.xml";
