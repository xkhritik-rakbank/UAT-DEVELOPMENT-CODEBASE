	...
	public void AWB_run() {
		...
		try {
			...
			if (sessionID.trim().equalsIgnoreCase("")) {
				...
				startDAO_AWB_Gen(cabinetName, jtsIP, jtsPort, sessionID, queueID, socketConnectionTimeout,
						integrationWaitTime, socketDetailsMap);
				startDCC_AWB_Gen(cabinetName, jtsIP, jtsPort, sessionID, queueID_DCC, socketConnectionTimeout,
						integrationWaitTime, socketDetailsMap);
